...
import { AlertCircle, Facebook, RefreshCw, Link2 } from "lucide-react";
...
export function FacebookPagesIntegration() {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Connect your Facebook Pages to manage posts and view insights
        </CardDescription>
      </CardHeader>
      <CardContent>
        {error && (
              ...
              <div key={page.id} className="flex items-center justify-between p-4 border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Followers: {page.followers_count?.toLocaleString() || 0}
                  </p>
                </div>
